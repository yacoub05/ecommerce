...
const ProductDetails= ({productDetails,productsData}) => {
        ...
        <div className='product-detail-container'>
            ...
            <div className='product-detail-desc'>
                ...
                <div className='buttons'>
                    <button type='button' className='add-to-cart' onClick={()=>onAdd(productDetails, qty )}>Add to Cart</button>
...
export const getStaticProps = async ({params: {slug}})=> {
    ...
    return {
      props: {productDetails, productsData}
    }
